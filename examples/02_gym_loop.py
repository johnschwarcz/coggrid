...
from coggrid import CogGridConfig, CogGridEnv
...
class BayesOptimal:
    """Exact posterior over the joint realization, updated online."""
...
bayes = run(BayesOptimal(), expose_likelihood=True)
print(f"bayes-exact mean per-step reward: {bayes:.3f}")
